...
class RoutingSTPReader(STPReader):
    def __init__(self, fileName: str, ports: list[gp_Pnt], portDirection: list[list[int]] ,move: tuple[float, float, float] = (0,0,0), rotate: tuple[float, float, float, float] = (1,0,0,0)) -> None:
